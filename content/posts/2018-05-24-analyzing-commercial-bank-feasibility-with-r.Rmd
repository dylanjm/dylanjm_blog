...
I hope you enjoyed this small tutorial on taking secondary data and turning it into valuable graphics that can be easily digested. While this would only be a small part of the consulting process for my client, I have created a reproducible graphic that, with only a few small changes, can give this exact analysis for any state in the country. I have also been able to bypass having to use excel and deal with the potential overhead of the datasets being too large to deal with. If you have any questions or would like to see more please feel free to ask! You can find a gist of my script at [github](https://gist.github.com/dylanjm/c5e5e5f74dbadc8145116f7ee964e734)∎